    ...
    files.forEach((file) => {
      ...
      reader.onload = (event) => {
        setFormData((prev) => ({
          ...
          images: [
            ...prev.images,
            { imageUrl: event.target.result, public_id: Date.now() },
          ],
        }));
      };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            placeholder="Agent/Company name (optional)"
          />
        </div>
      </div>
    </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between mt-8 pt-6 border-t">
              ...
              {currentStep < 4 ? (
                ...
                <button
                  type="submit"
                  className="flex items-center px-8 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-all shadow-lg hover:shadow-xl"
                >
